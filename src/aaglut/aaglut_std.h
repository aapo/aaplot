...
/*
 * Initialization functions, see aaglut_init.c
 */
...
/*
 * Process loop function, see aaglut_main.c
 */
OGAPI void    OGAPIENTRY glutMainLoop( void );

/*
 * Window management functions, see aaglut_window.c
 */
...
/*
 * Display-connected functions, see aaglut_display.c
 */
...
/*
 * Global callback functions, see aaglut_callbacks.c
 */
...
/*
 * Window-specific callback functions, see aaglut_callbacks.c
 */
...
/*aapo OGAPI void    OGAPIENTRY glutJoystickFunc(
...
/*
 * State setting and retrieval functions, see aaglut_state.c
 */
...
OGAPI int   OGAPIENTRY glutBitmapLength( const unsigned char* string );
