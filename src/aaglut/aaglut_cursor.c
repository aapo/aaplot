...
#define MAP_CURSOR_C(a,b)                                     \
    case a:                                                 \
        ...
        switch( cursorID )
        {
            MAP_CURSOR_C( GLUT_CURSOR_RIGHT_ARROW, XC_right_ptr);
            MAP_CURSOR_C( GLUT_CURSOR_LEFT_ARROW,  XC_left_ptr);
            MAP_CURSOR_C( GLUT_CURSOR_INFO,        XC_hand1);
            MAP_CURSOR_C( GLUT_CURSOR_DESTROY,     XC_pirate);
            MAP_CURSOR_C( GLUT_CURSOR_HELP,        XC_question_arrow);
            MAP_CURSOR_C( GLUT_CURSOR_CYCLE,       XC_exchange);
            MAP_CURSOR_C( GLUT_CURSOR_SPRAY,       XC_spraycan);
            MAP_CURSOR_C( GLUT_CURSOR_WAIT,        XC_watch);
            MAP_CURSOR_C( GLUT_CURSOR_TEXT,        XC_xterm);
            MAP_CURSOR_C( GLUT_CURSOR_CROSSHAIR,   XC_crosshair);
            MAP_CURSOR_C( GLUT_CURSOR_UP_DOWN,     XC_sb_v_double_arrow);
            MAP_CURSOR_C( GLUT_CURSOR_LEFT_RIGHT,  XC_sb_h_double_arrow);
            MAP_CURSOR_C( GLUT_CURSOR_TOP_SIDE,    XC_top_side);
            MAP_CURSOR_C( GLUT_CURSOR_BOTTOM_SIDE, XC_bottom_side);
            MAP_CURSOR_C( GLUT_CURSOR_LEFT_SIDE,   XC_left_side);
            MAP_CURSOR_C( GLUT_CURSOR_RIGHT_SIDE,  XC_right_side);
            MAP_CURSOR_C( GLUT_CURSOR_TOP_LEFT_CORNER,     XC_top_left_corner);
            MAP_CURSOR_C( GLUT_CURSOR_TOP_RIGHT_CORNER,    XC_top_right_corner);
            MAP_CURSOR_C( GLUT_CURSOR_BOTTOM_RIGHT_CORNER,
                        XC_bottom_right_corner);
            MAP_CURSOR_C( GLUT_CURSOR_BOTTOM_LEFT_CORNER, XC_bottom_left_corner);
            /* MAP_CURSOR_C( GLUT_CURSOR_NONE,        XC_bogosity); */
...
#       define ZAP_CURSOR_C(a,b)                                   \
        ...
        switch( cursorID )
        {
            MAP_CURSOR_C( GLUT_CURSOR_RIGHT_ARROW, IDC_ARROW     );
            MAP_CURSOR_C( GLUT_CURSOR_LEFT_ARROW,  IDC_ARROW     );
            MAP_CURSOR_C( GLUT_CURSOR_INFO,        IDC_HELP      );
            MAP_CURSOR_C( GLUT_CURSOR_DESTROY,     IDC_CROSS     );
            MAP_CURSOR_C( GLUT_CURSOR_HELP,        IDC_HELP      );
            MAP_CURSOR_C( GLUT_CURSOR_CYCLE,       IDC_SIZEALL   );
            MAP_CURSOR_C( GLUT_CURSOR_SPRAY,       IDC_CROSS     );
            MAP_CURSOR_C( GLUT_CURSOR_WAIT,        IDC_WAIT      );
            MAP_CURSOR_C( GLUT_CURSOR_TEXT,        IDC_UPARROW   );
            MAP_CURSOR_C( GLUT_CURSOR_CROSSHAIR,   IDC_CROSS     );
            /* MAP_CURSOR_C( GLUT_CURSOR_NONE,        IDC_NO        ); */
            ZAP_CURSOR_C( GLUT_CURSOR_NONE,        NULL           );

        default:
            MAP_CURSOR_C( GLUT_CURSOR_UP_DOWN,     IDC_ARROW     );
        }
#endif
    }
    if( !error )
