...
/*window_number, function,parameters, plot_size, x_step, title*/
addRFunctionWithP(0,&my_func,p1,1.0,0.001,"parabola1");
...
p2[1]=-3.1;
p2[2]= 3.8;
addRFunctionWithP(0,&my_func,p2,1.0,0.001,"parabola2");
