/*
Esimerkki kuinka gsl_matrix muutetaan kahdeksi tavalliseksi
taulukoksi, jotka voidaan suoraan piirtaa.

Lataa tiedostosta pisteita ja muodostaa niista matriisin.
*/
#include "aaplot.c"
...
addTableDataArrays(0,number_of_points,x,y,2, "gsl_matriisista taulukko",0,1,0);
